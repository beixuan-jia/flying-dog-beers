...
df_google = pd.read_csv('https://github.com/beixuan-jia/flying-dog-beers/master/US_Corona.csv')
df_apple = pd.read_csv('https://github.com/beixuan-jia/flying-dog-beers/master/US_Corona.csv')
# category dropdown 
